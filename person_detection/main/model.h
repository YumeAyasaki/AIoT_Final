...
#ifndef TENSORFLOW_LITE_UTIL_TFLITE_DATA_H_
#define TENSORFLOW_LITE_UTIL_TFLITE_DATA_H_

extern const unsigned char person_direction[];
extern const int tflite_len;

#endif  // TENSORFLOW_LITE_UTIL_TFLITE_DATA_H_
